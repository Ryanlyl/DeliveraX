...
from api_server.routers import artifacts, checkpoints, health, pipelines, projects, providers, stages
...
from api_server.storage.projects import JsonProjectStore
...
def _load_dotenv() -> None:
    ...
    # Repo root is two levels above this file: server/api_server/main.py → repo_root
...
def create_app() -> FastAPI:
    ...
    app.state.project_store = JsonProjectStore(settings.resolved_artifacts_root)
