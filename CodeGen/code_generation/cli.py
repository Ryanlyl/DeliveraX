...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--workspace-dir",
        default=str(Path(__file__).resolve().parents[2] / "SolDesign" / ".workspace"),
        help="Existing workspace that contains fetched repositories. Defaults to SolDesign/.workspace.",
    )
    parser.add_argument(
        "--task-id",
